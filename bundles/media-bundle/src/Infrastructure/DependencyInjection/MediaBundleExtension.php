...
use Zenchron\FileManagerBundle\Domain\Enum\ImageResizeDriver;
...
use Zenchron\FileManagerBundle\Infrastructure\Persistence\Dbal\Types\MediaIdType;
use Zenchron\FileManagerBundle\Infrastructure\Persistence\Dbal\Types\ThumbnailCollectionType;
use Zenchron\FileManagerBundle\Infrastructure\Persistence\Dql\Mysql\MimeSubType;
use Zenchron\FileManagerBundle\Infrastructure\Persistence\Dql\Mysql\MimeType;
use Zenchron\FileManagerBundle\Infrastructure\Persistence\Dql\Mysql\Month;
use Zenchron\FileManagerBundle\Infrastructure\Persistence\Dql\Mysql\Year;
use Zenchron\FileManagerBundle\Infrastructure\Persistence\Orm\Repository\DoctrineOrmMediaRepository;
use Zenchron\FileManagerBundle\Infrastructure\Persistence\Orm\Repository\DoctrineOrmUserMediaRepository;
...
class MediaBundleExtension extends Extension implements PrependExtensionInterface
{
    ...
    public const CONFIG_DOMAIN_NAME   = 'zenchron_file_manager';
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        $container->setParameter('zenchron_file_manager_api_prefix', $config['api_prefix']);
    ...
    public function prepend(ContainerBuilder $container): void
    {
        ...
        $container->prependExtensionConfig('twig', [
            ...
            'globals' => [
                'ranky_media' => '@Zenchron\FileManagerBundle\Presentation\Twig\MediaTwigService',
            ],
        ]);
        ...
        $container->prependExtensionConfig('doctrine', [
            ...
            'orm' => [
                ...
                'mappings' => [
                    'ZenchronFileManagerBundle' => [
                        'type' => 'attribute',
                        'dir' => \dirname(__DIR__, 3).'/src/Domain',
                        'prefix' => 'Zenchron\FileManagerBundle\Domain',
                    ],
                ],
            ],
        ]);
