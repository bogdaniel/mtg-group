...
use Zenchron\FileManagerBundle\Application\CreateMedia\CreateMedia;
use Zenchron\FileManagerBundle\Application\CreateMedia\UploadedFileRequest;
use Zenchron\FileManagerBundle\Infrastructure\Event\PostCreateEvent;
use Zenchron\FileManagerBundle\Infrastructure\Event\PreCreateEvent;
...
#[Route('/zenchron/media', name: 'ranky_media_upload', methods: ['POST'], priority: 3)]
