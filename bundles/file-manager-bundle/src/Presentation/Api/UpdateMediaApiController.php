...
use Zenchron\FileBundle\Application\UpdateMedia\UpdateMedia;
use Zenchron\FileBundle\Application\UpdateMedia\UpdateMediaRequest;
use Zenchron\FileBundle\Infrastructure\Event\PostUpdateEvent;
use Zenchron\FileBundle\Infrastructure\Event\PreUpdateEvent;
use Zenchron\FileBundle\Infrastructure\Validation\UpdateMediaConstraint;
...
#[Route('/zenchron/dashboard/{id}', name: 'zenchron_file_update', requirements: ['id' => '[0-7][0-9A-HJKMNP-TV-Z]{25}'], methods: ['PUT'], priority: 2)]
