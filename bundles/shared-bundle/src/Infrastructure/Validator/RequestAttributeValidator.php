...
namespace Zenchron\SharedBundle\Infrastructure\Validator;
...
use Zenchron\SharedBundle\Domain\Exception\ApiProblem\ApiProblem;
use Zenchron\SharedBundle\Domain\Exception\ApiProblem\ValidationFailedException;
...
class RequestAttributeValidator
{
    ...
    {
        /** @var  \Zenchron\SharedBundle\Application\Dto\RequestDtoInterface $requestDtoClass */
